...
public class LocationPollerService extends Service {
	...
	private class PollerThread extends WakefulThread {
		...
		private Runnable onTimeout = new Runnable() {
			...
			public void run() {
				if (ActivityCompat.checkSelfPermission(LocationPollerService.this, android.Manifest.permission.ACCESS_FINE_LOCATION)
						!= PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(LocationPollerService.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//		 */
		...
		private void requestLocationUdpate() {
			try {
				if (ActivityCompat.checkSelfPermission(LocationPollerService.this,
						android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
						&& ActivityCompat.checkSelfPermission(LocationPollerService.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
					// TODO: Consider calling
					//    ActivityCompat#requestPermissions
					// here to request the missing permissions, and then overriding
					//   public void onRequestPermissionsResult(int requestCode, String[] permissions,
