...
/**
 * Created by dwi.prayogo on 10/11/2017.
 */

public class PickTempatLahir extends LinearLayout {
    ...
    public PickTempatLahir(Context context, String labelText,  String tableName, String fieldName, String fieldID) {
        super(context);
        ...
        val = null;
        btnShow.setText("Select Tempat Lahir");
        ...
        String sqlqueryID = "select " + fieldID + " from " + tableName + " order by " + fieldID;
